      ...
      <div className="flex flex-col min-w-0 flex-1 md:flex-1">
        ...
        >
          ...
          <button onClick={toggleFullscreen} title={isFullscreen ? 'تصغير' : 'تكبير'}
            className="absolute bottom-3 right-3 w-8 h-8 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200 z-10"
            style={{ background: 'rgba(0,0,0,0.60)', border: '1px solid rgba(200,170,100,0.18)', color: C.text70, backdropFilter: 'blur(8px)', borderRadius: '4px' }}>
            {isFullscreen
